	   ...
	   PCTCOUNT="0";
        ...
        "postdd")
            ...
            [ $type == ext4 -o $type == xfs -o $type == btrfs ] && {
              ...
              [ $ISDHCP == '1' ] && [ -f $therealospath/etc/network/interfaces ] && [ -z "$(sed -n '/iface eth0 inet dhcp/p' $therealospath/etc/network/interfaces)" ] && echo -e "auto eth0\niface eth0 inet dhcp" >> $therealospath/etc/network/interfaces             
